...
export default function PaymentModal({ alumnos, grupos, onClose }) {
  ...
  <option disabled>Cargando alumnos...</option>
          ...
          <select className="w-full mb-4 p-2 border-4 rounded" onChange={(e) => setSelectedMes(e.target.value)}>
          ...
          <button className="w-full bg-[#FF9A3D] text-white py-2 rounded hover:bg-orange-600" onClick={handleConfirm}>
            Confirmar
          </button>
